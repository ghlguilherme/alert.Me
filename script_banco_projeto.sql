...
CREATE TABLE CONVERSA(
    CONVERSA_ID INT AUTO_INCREMENT,
    CONVERSA_PESSOA1 INT NOT NULL,
    CONVERSA_PESSOA2 INT NOT NULL,
    PRIMARY KEY(CONVERSA_ID)
);

CREATE TABLE MENSAGEM(
    MENSAGEM_ID INT AUTO_INCREMENT,
    MENSAGEM_CONVERSA INT NOT NULL,
    MENSAGEM_DESCRICAO VARCHAR(300) NOT NULL,
    MENSAGEM_DATAHORA TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP NOT NULL,
